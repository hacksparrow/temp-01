...
__decorate([
    ...
    __param(0, rest_1.requestBody({
        content: {
            'application/json': {
                schema: rest_1.getModelSchemaRef(models_1.Book, { exclude: ['id'] }),
            },
        },
    })),
    ...
    rest_1.get('/books', {
        responses: {
            '200': {
                ...
                content: {
                    'application/json': {
                        schema: { type: 'array', items: rest_1.getModelSchemaRef(models_1.Book) },
                    },
                },
            },
        },
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Number, models_1.Book]),
    __metadata("design:returntype", Promise)
